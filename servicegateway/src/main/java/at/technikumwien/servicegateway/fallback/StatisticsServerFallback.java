...
@Component
@Log
public class StatisticsServerFallback implements FallbackProvider {
    private static final String RESPONSE_MESSAGE = "Statistics service is currently not available";
